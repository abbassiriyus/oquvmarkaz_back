...
CREATE TABLE users (
	...
	`time_update` datetime default current_timestamp not null,
    ...
    `rooms` LONGTEXT NOT NULL default ""
);
-- SQLINES LICENSE FOR EVALUATION USE ONLY
...
CREATE TABLE `verify`(
 ...
 CREATE TABLE registerCourse( 
    ...
    `propose_time` datetime default current_timestamp NOT NULL,
